      ...
      >
        <View className="justify-between flex-1">
          <View className="flex-row justify-center items-center mt-8 space-x-4">
            ...
            <View className="bg-[#A811DA] rounded-3xl h-full py-2 pl-6 pr-8 flex-row items-center space-x-2">
              <Image
                className="w-8 h-12"
            ...
            {admin ? (
              <TouchableOpacity onPress={deleteEvent}>
                <View className="items-center">
                  <View className="bg-[#8A1AAF] py-3 px-10 rounded-3xl">
              ...
              <>
                <TouchableOpacity onPress={join}>
                  <View className="items-center">
                    <View className="flex-row space-x-1 bg-[#8A1AAF] py-3 px-10 rounded-3xl">
